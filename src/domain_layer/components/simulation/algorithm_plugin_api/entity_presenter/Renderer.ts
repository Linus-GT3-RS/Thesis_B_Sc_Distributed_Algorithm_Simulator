import { GenericBiDirectionalEdge, GenericNodeState } from "../entities/state_entities/AlgoData.js";
...
export abstract class IAlgorithmNodeRenderer {
    ...
    // throws error
    public abstract provide(node: GenericNodeState): Array<RenderAttribute>;
