import { ILocalDataEnvSystem, ILocalDataEnvSystem as ILocalDataSystem, MutableNodeStateKeys } from "../../../algorithm_plugins/api/entities/behaviour_entities/EnvironmentSystems.js";
