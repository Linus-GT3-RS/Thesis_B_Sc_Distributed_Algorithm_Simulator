...
import { ISystemOutgoingMessages } from "../../algorithm_plugin_api/actions/ActionHandler.Readme";
import { GenericBiDirectionalEdge, GenericMessage, GenericMessageData } from "../../algorithm_plugin_api/entities/state_entities/AlgoData.js";
...
export class CommunicationSystem implements ISystemOutgoingMessages {
    ...
    constructor(
        ...
        private edges: ReadonlyStore<GenericBiDirectionalEdge>,
